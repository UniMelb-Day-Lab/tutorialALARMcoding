...
alarmcoding_PCR_multiplex_1 %>%
  ...
  knitr::kable(caption = "Table 1. Details about primers used in multiplex 1 of the <em>ALARM</em>coding PCR genotyping protocol", align = "lcccc", escape = FALSE) %>% 
...
alarmcoding_PCR_multiplex_1 %>%
  ...
  knitr::kable(caption = "Table 2. Details about sequences genotyped in the multiplex 1 of the <em>ALARM</em>coding protocol", align = "lcccc", escape = FALSE) %>% 
  kable_styling(bootstrap_options = c("condensed", "responsive"), full_width = T) %>% 
