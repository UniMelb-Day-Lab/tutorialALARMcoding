...
alarmcoding_PCR_multiplex_3 %>%
  ...
  knitr::kable(caption = "Details about primers used in Multiplex 3 of the <em>ALARM</em>coding PCR genotyping protocol", align = "lcccc", escape = FALSE) %>% 
...
alarmcoding_PCR_multiplex_3 %>%
  ...
  knitr::kable(caption = "Table 2. Details about sequences genotyped in Multiplex 3 of the <em>ALARM</em>coding protocol", align = "lcccc", escape = FALSE) %>% 
  kable_styling(bootstrap_options = c("condensed", "responsive"), full_width = T) %>% 
