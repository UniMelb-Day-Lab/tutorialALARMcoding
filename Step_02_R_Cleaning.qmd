...
for (filename in filenames_NT) {
  ...
  search_Survey <- c("Survey_2017", "Survey_2022")
...
```{r}
Survey_2017_merged_crt_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_crt.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2017_merged_dhfr_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_dhfr.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2017_merged_dhps1_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_dhps1.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2017_merged_dhps2_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_dhps2.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2017_merged_K131_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_K131.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2017_merged_K132_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_K132.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2017_merged_mdr11_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_mdr11.*", c("SeqID", "Marker","Survey",  "Reference"))
Survey_2017_merged_mdr12_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_mdr12.*", c("SeqID", "Marker","Survey",  "Reference"))
Survey_2017_merged_mdr13_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2017_mdr13.*", c("SeqID", "Marker","Survey",  "Reference"))

Survey_2022_merged_crt_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_crt.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_dhfr_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_dhfr.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_dhps1_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_dhps1.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_dhps2_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_dhps2.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_K131_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_K131.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_K132_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_K132.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_mdr11_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_mdr11.*", c("SeqID", "Marker","Survey",  "Reference"))
Survey_2022_merged_mdr12_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_mdr12.*", c("SeqID", "Marker","Survey",  "Reference"))
Survey_2022_merged_mdr13_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_mdr13.*", c("SeqID", "Marker","Survey",  "Reference"))
Survey_2022_merged_aat1_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_aat1.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_pfs471_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_pfs471.*", c("SeqID", "Marker", "Survey", "Reference"))
Survey_2022_merged_pfs472_data <- merge_files("05_All_DrugR_Haplotypes/temp", "Survey_2022_pfs472.*", c("SeqID", "Marker", "Survey", "Reference"))

### Join Surveys ###
merged_crt_data <- bind_rows(Survey_2017_merged_crt_data, Survey_2022_merged_crt_data)
merged_dhfr_data <- bind_rows(Survey_2017_merged_dhfr_data, Survey_2022_merged_dhfr_data)
merged_dhps1_data <- bind_rows(Survey_2017_merged_dhps1_data, Survey_2022_merged_dhps1_data)
merged_dhps2_data <- bind_rows(Survey_2017_merged_dhps2_data, Survey_2022_merged_dhps2_data)
merged_K131_data <- bind_rows(Survey_2017_merged_K131_data, Survey_2022_merged_K131_data)
merged_K132_data <- bind_rows(Survey_2017_merged_K132_data, Survey_2022_merged_K132_data)
merged_mdr11_data <- bind_rows(Survey_2017_merged_mdr11_data, Survey_2022_merged_mdr11_data)
merged_mdr12_data <- bind_rows(Survey_2017_merged_mdr12_data, Survey_2022_merged_mdr12_data)
merged_mdr13_data <- bind_rows(Survey_2017_merged_mdr13_data, Survey_2022_merged_mdr13_data)
```
...
syn_nonsyn_crt <- syn_nonsyn_diffs(merged_crt_data)
syn_nonsyn_dhfr <- syn_nonsyn_diffs(merged_dhfr_data)
syn_nonsyn_dhps1 <- syn_nonsyn_diffs(merged_dhps1_data)
syn_nonsyn_dhps2 <- syn_nonsyn_diffs(merged_dhps2_data)
syn_nonsyn_K131 <- syn_nonsyn_diffs(merged_K131_data)
syn_nonsyn_K132 <- syn_nonsyn_diffs(merged_K132_data)
syn_nonsyn_mdr11 <- syn_nonsyn_diffs(merged_mdr11_data)
syn_nonsyn_mdr12 <- syn_nonsyn_diffs(merged_mdr12_data)
syn_nonsyn_mdr13 <- syn_nonsyn_diffs(merged_mdr13_data)
syn_nonsyn_aat1 <- syn_nonsyn_diffs(Survey_2022_merged_aat1_data)
syn_nonsyn_pfs471 <- syn_nonsyn_diffs(Survey_2022_merged_pfs471_data)
syn_nonsyn_pfs472 <- syn_nonsyn_diffs(Survey_2022_merged_pfs472_data)
```
